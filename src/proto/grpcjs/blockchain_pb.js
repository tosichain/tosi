...
goog.exportSymbol('proto.blockchain.OffchainComputationParameters', null, global);
 ...
 * @constructor
 */
proto.blockchain.OffchainComputationParameters = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.blockchain.OffchainComputationParameters, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.blockchain.OffchainComputationParameters.displayName = 'proto.blockchain.OffchainComputationParameters';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.blockchain.WorldState.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    offchainComputation: (f = msg.getOffchainComputation()) && proto.blockchain.OffchainComputationParameters.toObject(includeInstance, f)
  };
...
proto.blockchain.WorldState.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new proto.blockchain.OffchainComputationParameters;
      reader.readMessage(value,proto.blockchain.OffchainComputationParameters.deserializeBinaryFromReader);
      msg.setOffchainComputation(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.blockchain.WorldState.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getOffchainComputation();
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.blockchain.OffchainComputationParameters.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional OffchainComputationParameters offchain_computation = 5;
 * @return {?proto.blockchain.OffchainComputationParameters}
 */
proto.blockchain.WorldState.prototype.getOffchainComputation = function() {
  return /** @type{?proto.blockchain.OffchainComputationParameters} */ (
    jspb.Message.getWrapperField(this, proto.blockchain.OffchainComputationParameters, 5));
};


/**
 * @param {?proto.blockchain.OffchainComputationParameters|undefined} value
 * @return {!proto.blockchain.WorldState} returns this
*/
proto.blockchain.WorldState.prototype.setOffchainComputation = function(value) {
  return jspb.Message.setWrapperField(this, 5, value);
};
 ...
 * @return {!proto.blockchain.WorldState} returns this
 */
proto.blockchain.WorldState.prototype.clearOffchainComputation = function() {
  return this.setOffchainComputation(undefined);
};
 ...
 * @return {boolean}
 */
proto.blockchain.WorldState.prototype.hasOffchainComputation = function() {
  return jspb.Message.getField(this, 5) != null;
};
 ...
 * @return {!Object}
 */
proto.blockchain.OffchainComputationParameters.prototype.toObject = function(opt_includeInstance) {
  return proto.blockchain.OffchainComputationParameters.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.blockchain.OffchainComputationParameters} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.blockchain.OffchainComputationParameters.toObject = function(includeInstance, msg) {
  var f, obj = {
    daCommitteeSampleSize: jspb.Message.getFieldWithDefault(msg, 1, 0),
    stateCommitteeSampleSize: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
 ...
 * @return {!proto.blockchain.OffchainComputationParameters}
 */
proto.blockchain.OffchainComputationParameters.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.blockchain.OffchainComputationParameters;
  return proto.blockchain.OffchainComputationParameters.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.blockchain.OffchainComputationParameters} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.blockchain.OffchainComputationParameters}
 */
proto.blockchain.OffchainComputationParameters.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      var value = /** @type {number} */ (reader.readUint32());
      msg.setDaCommitteeSampleSize(value);
      break;
    case 2:
      var value = /** @type {number} */ (reader.readUint32());
      msg.setStateCommitteeSampleSize(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.blockchain.OffchainComputationParameters.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.blockchain.OffchainComputationParameters.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.blockchain.OffchainComputationParameters} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.blockchain.OffchainComputationParameters.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDaCommitteeSampleSize();
  if (f !== 0) {
    writer.writeUint32(
      1,
      f
  ...
  f = message.getStateCommitteeSampleSize();
  if (f !== 0) {
    writer.writeUint32(
      2,
      f
...
/**
 * optional uint32 da_committee_sample_size = 1;
 * @return {number}
 */
proto.blockchain.OffchainComputationParameters.prototype.getDaCommitteeSampleSize = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.blockchain.OffchainComputationParameters} returns this
 */
proto.blockchain.OffchainComputationParameters.prototype.setDaCommitteeSampleSize = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};


/**
 * optional uint32 state_committee_sample_size = 2;
 * @return {number}
 */
proto.blockchain.OffchainComputationParameters.prototype.getStateCommitteeSampleSize = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.blockchain.OffchainComputationParameters} returns this
 */
proto.blockchain.OffchainComputationParameters.prototype.setStateCommitteeSampleSize = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
