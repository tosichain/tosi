...
proto.blockchain.ComputeClaim = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.blockchain.ComputeClaim.repeatedFields_, null);
};
 ...
 * @const
 */
proto.blockchain.ComputeClaim.repeatedFields_ = [7];
...
proto.blockchain.ComputeClaim.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    courtCid: jspb.Message.getFieldWithDefault(msg, 3, ""),
    appCid: jspb.Message.getFieldWithDefault(msg, 4, ""),
    inputCid: jspb.Message.getFieldWithDefault(msg, 5, ""),
    outputCid: jspb.Message.getFieldWithDefault(msg, 6, ""),
    daInfoList: jspb.Message.toObjectList(msg.getDaInfoList(),
    proto.blockchain.DAInfo.toObject, includeInstance),
    returnCode: jspb.Message.getFieldWithDefault(msg, 8, 0),
    maxCartesiCycles: jspb.Message.getFieldWithDefault(msg, 9, "0")
  };
...
proto.blockchain.ComputeClaim.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      ...
      break;
    case 7:
      var value = new proto.blockchain.DAInfo;
      reader.readMessage(value,proto.blockchain.DAInfo.deserializeBinaryFromReader);
      msg.addDaInfo(value);
      break;
    case 8:
      var value = /** @type {number} */ (reader.readUint32());
...
proto.blockchain.ComputeClaim.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getDaInfoList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      7,
      f,
      proto.blockchain.DAInfo.serializeBinaryToWriter
    );
  }
...
/**
 * optional string court_cid = 3;
 * @return {string}
 */
proto.blockchain.ComputeClaim.prototype.getCourtCid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.blockchain.ComputeClaim} returns this
 */
proto.blockchain.ComputeClaim.prototype.setCourtCid = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};


/**
 * optional string app_cid = 4;
 * @return {string}
 */
proto.blockchain.ComputeClaim.prototype.getAppCid = function() {
 ...
 * @return {!proto.blockchain.ComputeClaim} returns this
 */
proto.blockchain.ComputeClaim.prototype.setAppCid = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};


/**
 * optional string input_cid = 5;
 * @return {string}
 */
proto.blockchain.ComputeClaim.prototype.getInputCid = function() {
 ...
 * @return {!proto.blockchain.ComputeClaim} returns this
 */
proto.blockchain.ComputeClaim.prototype.setInputCid = function(value) {
 ...
 * @return {string}
 */
proto.blockchain.ComputeClaim.prototype.getOutputCid = function() {
 ...
 * @return {!proto.blockchain.ComputeClaim} returns this
 */
proto.blockchain.ComputeClaim.prototype.setOutputCid = function(value) {
 ...
 * @return {!Array<!proto.blockchain.DAInfo>}
 */
proto.blockchain.ComputeClaim.prototype.getDaInfoList = function() {
  return /** @type{!Array<!proto.blockchain.DAInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.blockchain.DAInfo, 7));
};


/**
 * @param {!Array<!proto.blockchain.DAInfo>} value
 * @return {!proto.blockchain.ComputeClaim} returns this
*/
proto.blockchain.ComputeClaim.prototype.setDaInfoList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 7, value);
};


/**
 * @param {!proto.blockchain.DAInfo=} opt_value
 * @param {number=} opt_index
 * @return {!proto.blockchain.DAInfo}
 */
proto.blockchain.ComputeClaim.prototype.addDaInfo = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 7, opt_value, proto.blockchain.DAInfo, opt_index);
};
 ...
 * @return {!proto.blockchain.ComputeClaim} returns this
 */
proto.blockchain.ComputeClaim.prototype.clearDaInfoList = function() {
  return this.setDaInfoList([]);
};


/**
 * optional uint32 return_code = 8;
 * @return {number}
 */
proto.blockchain.ComputeClaim.prototype.getReturnCode = function() {
 ...
 * @return {!proto.blockchain.ComputeClaim} returns this
 */
proto.blockchain.ComputeClaim.prototype.setReturnCode = function(value) {
  return jspb.Message.setProto3IntField(this, 8, value);
};


/**
 * optional uint64 max_cartesi_cycles = 9;
 * @return {string}
 */
 ...
 * @const
 */
proto.blockchain.BlockProof.repeatedFields_ = [4];
