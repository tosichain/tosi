...
proto.node.GetBLSPublicKeyResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    publicKeyHex: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
...
/**
 * optional string public_key_hex = 2;
 * @return {string}
 */
proto.node.GetBLSPublicKeyResponse.prototype.getPublicKeyHex = function() {
 ...
 * @return {!proto.node.GetBLSPublicKeyResponse} returns this
 */
proto.node.GetBLSPublicKeyResponse.prototype.setPublicKeyHex = function(value) {
